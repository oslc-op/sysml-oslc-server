...
<div class="container">
    <div class="jumbotron">
        ...
        <p class="lead">
            <a class="btn btn-warning btn-lg" href="<%= UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path("/store/projectCommits").build() %>" role="button">Select a Project Commit</a>
        </p>
    </div>
</div>
</body>
