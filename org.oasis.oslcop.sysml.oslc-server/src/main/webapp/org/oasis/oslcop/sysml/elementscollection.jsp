...
<%
  List<Element> resources = (List<Element>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Element QueryCapability</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Element QueryCapability&quot; results</h1>
