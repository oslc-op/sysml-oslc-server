...
if (request.getParameter("resourceUri") != null) {
    aResource = new Generalization (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aGeneralization") != null) {
        aResource = (Generalization) request.getAttribute("aGeneralization");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Generalization Resource} - update Generalization.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
