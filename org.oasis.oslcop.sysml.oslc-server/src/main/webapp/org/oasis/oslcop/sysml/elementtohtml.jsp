...
if (request.getParameter("resourceUri") != null) {
    aResource = new Element (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aElement") != null) {
        aResource = (Element) request.getAttribute("aElement");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Element Resource} - update Element.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
