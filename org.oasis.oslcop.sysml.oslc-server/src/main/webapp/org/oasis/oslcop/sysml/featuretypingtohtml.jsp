...
if (request.getParameter("resourceUri") != null) {
    aResource = new FeatureTyping (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aFeatureTyping") != null) {
        aResource = (FeatureTyping) request.getAttribute("aFeatureTyping");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local FeatureTyping Resource} - update FeatureTyping.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
