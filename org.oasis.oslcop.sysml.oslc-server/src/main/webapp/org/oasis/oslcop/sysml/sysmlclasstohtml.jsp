...
if (request.getParameter("resourceUri") != null) {
    aResource = new SysmlClass (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aSysmlClass") != null) {
        aResource = (SysmlClass) request.getAttribute("aSysmlClass");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local SysmlClass Resource} - update SysmlClass.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
