...
<head>
  ...
  <title>Query capability Relationship QueryCapability</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Relationship QueryCapability&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Relationship aResource : resources) { %>
