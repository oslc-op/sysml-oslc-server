...
<%
  List<Component> resources = (List<Component>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Component QueryCapability</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Component QueryCapability&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Component aResource : resources) { %>
