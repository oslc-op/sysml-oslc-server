...
<html lang="en">
  ...
  <div class="container">
    <div class="page-header">
      <h1>Sysml Server Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>org.oasis.oslcop.sysml.SysmlServerManager</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
