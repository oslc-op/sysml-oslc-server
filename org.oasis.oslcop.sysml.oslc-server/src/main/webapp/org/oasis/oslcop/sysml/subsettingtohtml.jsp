...
if (request.getParameter("resourceUri") != null) {
    aResource = new Subsetting (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aSubsetting") != null) {
        aResource = (Subsetting) request.getAttribute("aSubsetting");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Subsetting Resource} - update Subsetting.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
