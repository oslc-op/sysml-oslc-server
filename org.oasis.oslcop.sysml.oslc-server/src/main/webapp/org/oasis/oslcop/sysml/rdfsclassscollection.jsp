...
<%
  List<RdfsClass> resources = (List<RdfsClass>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability Class QueryCapability</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;Class QueryCapability&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (RdfsClass aResource : resources) { %>
