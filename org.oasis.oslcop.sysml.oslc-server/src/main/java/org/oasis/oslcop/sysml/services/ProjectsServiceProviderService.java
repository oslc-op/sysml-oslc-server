...
@Path("projects")
public class ProjectsServiceProviderService
{
    ...
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getProjectsServiceProvider(httpServletRequest, projectId, commitId);
    }
    ...
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getProjectsServiceProvider(httpServletRequest, projectId, commitId);
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/projectsserviceprovider.jsp");
