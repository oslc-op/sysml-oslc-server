...
public class ProjectsServiceProviderService5
{
    ...
    private static final Logger log = LoggerFactory.getLogger(ProjectsServiceProviderService5.class);
    ...
    public ProjectsServiceProviderService5()
    {
        super();
    }
