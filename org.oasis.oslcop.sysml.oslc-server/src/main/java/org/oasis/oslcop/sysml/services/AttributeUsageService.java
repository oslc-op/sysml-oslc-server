...
public class AttributeUsageService
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + SysmlDomainConstants.ATTRIBUTEUSAGE_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + SysmlDomainConstants.ATTRIBUTEUSAGE_TYPE + "\">" + SysmlDomainConstants.ATTRIBUTEUSAGE_LOCALNAME + "</a>" + "'}" +
