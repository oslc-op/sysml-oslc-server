...
public class ServiceProviderService10
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderService10.class);
    ...
    public ServiceProviderService10()
    {
        super();
    }
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.ATTRIBUTEUSAGE_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.ATTRIBUTEUSAGE_TYPE + "\">" + SysmlDomainConstants.ATTRIBUTEUSAGE_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<AttributeUsage> resources = SysmlServerManager.queryAttributeUsages(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/attributeusagescollection.jsp");
    ...
    public Response AttributeUsageSelector(
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/attributeusageselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
