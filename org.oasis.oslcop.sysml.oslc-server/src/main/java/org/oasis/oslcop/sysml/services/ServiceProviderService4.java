...
public class ServiceProviderService4
{
    ...
    private static final Logger log = LoggerFactory.getLogger(ServiceProviderService4.class);
    ...
    public ServiceProviderService4()
    {
        super();
    }
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.RELATIONSHIP_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.RELATIONSHIP_TYPE + "\">" + SysmlDomainConstants.RELATIONSHIP_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<Relationship> resources = SysmlServerManager.queryRelationships(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/relationshipscollection.jsp");
    ...
    public Response RelationshipSelector(
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/relationshipselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
