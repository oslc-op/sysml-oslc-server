...
public class ServiceProviderService3
{
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.CLASS_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.CLASS_TYPE + "\">" + SysmlDomainConstants.CLASS_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<SysmlClass> resources = SysmlServerManager.querySysmlClasss(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
    ...
    public Response SysmlClassSelector(
