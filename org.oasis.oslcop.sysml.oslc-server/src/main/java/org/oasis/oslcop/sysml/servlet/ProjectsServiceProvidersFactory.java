...
public class ProjectsServiceProvidersFactory
{
    private static Class<?>[] RESOURCE_CLASSES =
    {
        ProjectsServiceProviderService1.class, ProjectsServiceProviderService2.class, ProjectsServiceProviderService3.class, ProjectsServiceProviderService4.class, ProjectsServiceProviderService5.class
    };

    private ProjectsServiceProvidersFactory()
    {
        super();
    }
    ...
    public static URI constructURI(final ProjectsServiceProviderInfo serviceProviderInfo)
    {
    ...
    public static String constructIdentifier(final ProjectsServiceProviderInfo serviceProviderInfo)
    {
        return constructIdentifier(serviceProviderInfo.projectId, serviceProviderInfo.commitId);
    }

    public static ServiceProvider createServiceProvider(final ProjectsServiceProviderInfo serviceProviderInfo) 
