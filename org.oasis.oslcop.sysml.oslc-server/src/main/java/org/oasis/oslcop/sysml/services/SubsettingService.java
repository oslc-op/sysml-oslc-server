...
// End of user code
@Path("projects/{projectId}/subsettings")
public class SubsettingService
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + SysmlDomainConstants.SUBSETTING_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + SysmlDomainConstants.SUBSETTING_TYPE + "\">" + SysmlDomainConstants.SUBSETTING_LOCALNAME + "</a>" + "'}" +
    ...
    public void getSubsettingAsHtml(
        @PathParam("projectId") final String projectId, @PathParam("id") final String id
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            ...
            // Start of user code getSubsettingAsHtml_setAttributes
            // End of user code

            httpServletRequest.setAttribute("aResource", aSubsetting);
            httpServletRequest.setAttribute("resourceTypeName", SysmlDomainConstants.SUBSETTING_LOCALNAME);
            httpServletRequest.setAttribute("shapeUri", UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path(OslcConstants.PATH_RESOURCE_SHAPES).path(SysmlDomainConstants.SUBSETTING_PATH).build());
    ...
    public Compact getSubsettingCompact(
        @PathParam("projectId") final String projectId, @PathParam("id") final String id
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        // Start of user code getSubsettingCompact_init
        ...
        if (aSubsetting != null) {
            ...
            compact.setAbout(aSubsetting.getAbout());
            compact.setTitle(aSubsetting.toString());
            ...
            smallPreview.setDocument(UriBuilder.fromUri(aSubsetting.getAbout()).path("smallPreview").build());
    ...
    @Produces({ MediaType.TEXT_HTML })
    public void getSubsettingAsHtmlSmallPreview(
        @PathParam("projectId") final String projectId, @PathParam("id") final String id
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            httpServletRequest.setAttribute("aSubsetting", aSubsetting);
            // Start of user code getSubsettingAsHtmlSmallPreview_setAttributes
            // End of user code
            ...
            try {
                ...
                // End of user code
                String oslcPreviewDataSetAsString = PreviewFactory.getPreviewAsJsonString(aSubsetting, getterMethodNames, false);
    ...
    @Produces({ MediaType.TEXT_HTML })
    public void getSubsettingAsHtmlLargePreview(
        @PathParam("projectId") final String projectId, @PathParam("id") final String id
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            httpServletRequest.setAttribute("aSubsetting", aSubsetting);
            // Start of user code getSubsettingAsHtmlLargePreview_setAttributes
            // End of user code
            ...
            try {
                ...
                //TODO: modify the set of attributes to show in the preview
                // End of user code
                String oslcPreviewDataSetAsString = PreviewFactory.getPreviewAsJsonString(aSubsetting, getterMethodNames, true);
                httpServletRequest.setAttribute("resourcePreviewDataSet", oslcPreviewDataSetAsString);
            } catch (Exception e) {
