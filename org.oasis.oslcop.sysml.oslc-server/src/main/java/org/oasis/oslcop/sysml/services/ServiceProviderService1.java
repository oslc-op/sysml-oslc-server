...
public class ServiceProviderService1
{
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.SUBSETTING_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.SUBSETTING_TYPE + "\">" + SysmlDomainConstants.SUBSETTING_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<Subsetting> resources = SysmlServerManager.querySubsettings(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
    ...
    public Response SubsettingSelector(
        ...
        if (terms != null ) {
            ...
            if (resources!= null) {
                ...
                for (Subsetting resource : resources) {
                    ...
                    // Start of user code SubsettingSelector_setResponse
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/subsettingselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
