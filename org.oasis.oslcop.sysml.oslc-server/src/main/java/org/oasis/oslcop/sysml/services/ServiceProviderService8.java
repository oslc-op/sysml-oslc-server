...
public class ServiceProviderService8
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderService8.class);
    ...
    public ServiceProviderService8()
    {
        super();
    }
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.FEATURETYPING_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.FEATURETYPING_TYPE + "\">" + SysmlDomainConstants.FEATURETYPING_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<FeatureTyping> resources = SysmlServerManager.queryFeatureTypings(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/featuretypingscollection.jsp");
    ...
    public Response FeatureTypingSelector(
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/featuretypingselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
