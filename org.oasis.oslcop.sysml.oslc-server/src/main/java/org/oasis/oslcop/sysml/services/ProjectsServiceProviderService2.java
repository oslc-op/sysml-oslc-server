...
@Path("projects/{projectId}/commits/{commitId}/service2/relationships")
public class ProjectsServiceProviderService2
{
    ...
    private static final Logger log = LoggerFactory.getLogger(ProjectsServiceProviderService2.class);
    ...
    public ProjectsServiceProviderService2()
    {
        super();
    }
    ...
    @OslcQueryCapability
    (
        title = "Relationship QueryCapability",
        label = "Relationship QueryCapability",
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<Relationship> resources = delegate.queryRelationships(httpServletRequest, projectId, commitId, where, prefix, paging, page, pageSize);
    ...
    @OslcDialog
    (
         title = "Relationship SelectionDialog",
         label = "Relationship SelectionDialog",
         uri = "projects/{projectId}/commits/{commitId}/service2/relationships/selector",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {SysmlDomainConstants.RELATIONSHIP_TYPE},
         usages = {}
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            final List<Relationship> resources = delegate.RelationshipSelector(httpServletRequest, projectId, commitId, terms);
            if (resources!= null) {
            ...
            httpServletRequest.setAttribute("resourceTypeLabel", "Relationship");
            httpServletRequest.setAttribute("fieldsToList", "[\"Label\"]");
            // Start of user code RelationshipSelector_setAttribute_fieldsToList
