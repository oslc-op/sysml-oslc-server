...
public class FeatureTypingService
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + SysmlDomainConstants.FEATURETYPING_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + SysmlDomainConstants.FEATURETYPING_TYPE + "\">" + SysmlDomainConstants.FEATURETYPING_LOCALNAME + "</a>" + "'}" +
