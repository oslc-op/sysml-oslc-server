...
public class ProjectsServiceProviderService3
{
    ...
    private static final Logger log = LoggerFactory.getLogger(ProjectsServiceProviderService3.class);
    ...
    public ProjectsServiceProviderService3()
    {
        super();
    }
    ...
    @OslcQueryCapability
    (
        title = "Class QueryCapability",
        label = "Class QueryCapability",
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<SysmlClass> resources = delegate.querySysmlClasss(httpServletRequest, projectId, commitId, where, prefix, paging, page, pageSize);
    ...
    @OslcDialog
    (
         title = "Class SelectionDialog",
         label = "Class SelectionDialog",
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            final List<SysmlClass> resources = delegate.SysmlClassSelector(httpServletRequest, projectId, commitId, terms);
            if (resources!= null) {
            ...
            httpServletRequest.setAttribute("resourceTypeLabel", "Class");
            httpServletRequest.setAttribute("fieldsToList", "[\"Label\"]");
            // Start of user code SysmlClassSelector_setAttribute_fieldsToList
