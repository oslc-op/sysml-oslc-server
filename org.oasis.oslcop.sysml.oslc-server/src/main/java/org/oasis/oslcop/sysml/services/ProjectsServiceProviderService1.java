...
public class ProjectsServiceProviderService1
{
    ...
    private static final Logger log = LoggerFactory.getLogger(ProjectsServiceProviderService1.class);
    ...
    public ProjectsServiceProviderService1()
    {
        super();
    }
    ...
    @OslcQueryCapability
    (
        title = "Subsetting QueryCapability",
        label = "Subsetting QueryCapability",
    ...
    @OslcDialog
    (
         title = "Subsetting SelectionDialog",
         label = "Subsetting SelectionDialog",
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            httpServletRequest.setAttribute("resourceTypeLabel", "Subsetting");
            httpServletRequest.setAttribute("fieldsToList", "[\"Label\"]");
            // Start of user code SubsettingSelector_setAttribute_fieldsToList
