...
public class ServiceProviderService6
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderService6.class);
    ...
    public ServiceProviderService6()
    {
        super();
    }
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<Feature> resources = SysmlServerManager.queryFeatures(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/featureselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
