...
@Api(value = "Web Service for {" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "}")
public class PortUsageService
{
    ...
    @ApiOperation(
        value = "GET for resources of type {'" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "'}",
        notes = "GET for resources of type {'" + "<a href=\"" + SysmlDomainConstants.PORTUSAGE_TYPE + "\">" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "</a>" + "'}" +
