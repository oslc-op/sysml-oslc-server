...
public class ServiceProviderService11
{
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.PARTUSAGE_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.PARTUSAGE_TYPE + "\">" + SysmlDomainConstants.PARTUSAGE_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<PartUsage> resources = SysmlServerManager.queryPartUsages(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
    ...
    public Response PartUsageSelector(
