...
public class ServiceProviderService9
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderService9.class);
    ...
    public ServiceProviderService9()
    {
        super();
    }
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.PORTUSAGE_TYPE + "\">" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<PortUsage> resources = SysmlServerManager.queryPortUsages(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/portusagescollection.jsp");
    ...
    public Response PortUsageSelector(
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/portusageselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
