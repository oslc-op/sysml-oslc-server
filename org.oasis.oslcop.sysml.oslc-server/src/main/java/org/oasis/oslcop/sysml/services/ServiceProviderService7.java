...
public class ServiceProviderService7
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderService7.class);
    ...
    public ServiceProviderService7()
    {
        super();
    }
    ...
    @Operation(
        summary = "Query capability for resources of type {" + SysmlDomainConstants.FEATUREMEMBERSHIP_LOCALNAME + "}",
        description = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.FEATUREMEMBERSHIP_TYPE + "\">" + SysmlDomainConstants.FEATUREMEMBERSHIP_LOCALNAME + "</a>" + "}" +
                                                     ...
                                                     @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        List<FeatureMembership> resources = SysmlServerManager.queryFeatureMemberships(httpServletRequest, projectId, where, prefix, paging, page, pageSize);
                                       ...
                                       @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/featuremembershipscollection.jsp");
    ...
    public Response FeatureMembershipSelector(
        ...
        ) throws ServletException, IOException, JSONException
    {
        ...
        if (terms != null ) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/featuremembershipselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return null;
        }
    }
