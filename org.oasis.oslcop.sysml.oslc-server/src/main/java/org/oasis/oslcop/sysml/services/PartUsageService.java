...
public class PartUsageService
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + SysmlDomainConstants.PARTUSAGE_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + SysmlDomainConstants.PARTUSAGE_TYPE + "\">" + SysmlDomainConstants.PARTUSAGE_LOCALNAME + "</a>" + "'}" +
