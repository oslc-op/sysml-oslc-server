...
@Path("component")
public class ComponentServiceProviderService
{
    ...
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getComponentServiceProvider(httpServletRequest, id);
    }
    ...
    public void getHtmlServiceProvider(@PathParam("id") final String id) throws ServletException, IOException
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getComponentServiceProvider(httpServletRequest, id);
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/componentserviceprovider.jsp");
