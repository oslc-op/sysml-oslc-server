...
@OslcResourceShape(title = "LiteralBoolean Shape", describes = SysmlDomainConstants.LITERALBOOLEAN_TYPE)
public class LiteralBoolean
    extends LiteralExpression
    implements ILiteralBoolean
{
    ...
    public LiteralBoolean(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.LITERALBOOLEAN_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local LiteralBoolean Resource} - update LiteralBoolean.toString() to present resource as desired.";
