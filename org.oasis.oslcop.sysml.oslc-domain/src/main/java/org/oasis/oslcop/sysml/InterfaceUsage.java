    ...
    implements IInterfaceUsage
{
    ...
    public InterfaceUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.INTERFACEUSAGE_PATH,
        InterfaceUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local InterfaceUsage Resource} - update InterfaceUsage.toString() to present resource as desired.";
 ...
 result = getShortTitle();
    ...
    // Start of user code getterAnnotation:interfaceDefinition
    // End of user code
