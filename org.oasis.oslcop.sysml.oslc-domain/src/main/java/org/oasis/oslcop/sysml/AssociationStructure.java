    ...
    implements IAssociationStructure, ISysmlClass, IStructure
{
    ...
    public AssociationStructure(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ASSOCIATIONSTRUCTURE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local AssociationStructure Resource} - update AssociationStructure.toString() to present resource as desired.";
