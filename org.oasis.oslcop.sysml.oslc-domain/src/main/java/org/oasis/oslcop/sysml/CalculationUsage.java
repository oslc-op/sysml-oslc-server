...
// End of user code
@OslcNamespace(SysmlDomainConstants.CALCULATIONUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.CALCULATIONUSAGE_LOCALNAME)
@OslcResourceShape(title = "CalculationUsage Resource Shape", describes = SysmlDomainConstants.CALCULATIONUSAGE_TYPE)
public class CalculationUsage
    extends ActionUsage
    implements ICalculationUsage, IExpression, IStep
{
    // Start of user code attributeAnnotation:calculationDefinition
    // End of user code
    private Link calculationDefinition;
    ...
    public CalculationUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.CALCULATIONUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local CalculationUsage Resource} - update CalculationUsage.toString() to present resource as desired.";
    ...
    // Start of user code getterAnnotation:calculationDefinition
    // End of user code
    @OslcName("calculationDefinition")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "calculationDefinition")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.FUNCTION_TYPE})
    @OslcReadOnly(false)
    public Link getCalculationDefinition()
    {
        // Start of user code getterInit:calculationDefinition
        // End of user code
    ...
    // Start of user code setterAnnotation:calculationDefinition
    // End of user code
    public void setCalculationDefinition(final Link calculationDefinition )
    {
        // Start of user code setterInit:calculationDefinition
        // End of user code
        this.calculationDefinition = calculationDefinition;
    
        // Start of user code setterFinalize:calculationDefinition
        // End of user code
    }
