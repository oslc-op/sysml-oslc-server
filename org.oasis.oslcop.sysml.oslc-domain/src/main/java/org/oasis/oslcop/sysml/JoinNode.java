...
// End of user code
@OslcNamespace(SysmlDomainConstants.JOINNODE_NAMESPACE)
@OslcName(SysmlDomainConstants.JOINNODE_LOCALNAME)
@OslcResourceShape(title = "JoinNode Resource Shape", describes = SysmlDomainConstants.JOINNODE_TYPE)
    ...
    implements IJoinNode
{
    ...
    public JoinNode(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.JOINNODE_PATH,
        JoinNode.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local JoinNode Resource} - update JoinNode.toString() to present resource as desired.";
