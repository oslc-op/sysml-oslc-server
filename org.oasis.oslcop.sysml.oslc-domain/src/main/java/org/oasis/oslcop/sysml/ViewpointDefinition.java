    ...
    implements IViewpointDefinition
{
    ...
    public ViewpointDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.VIEWPOINTDEFINITION_PATH,
        ViewpointDefinition.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ViewpointDefinition Resource} - update ViewpointDefinition.toString() to present resource as desired.";
