...
// End of user code
@OslcNamespace(SysmlDomainConstants.VERIFICATIONCASEDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.VERIFICATIONCASEDEFINITION_LOCALNAME)
@OslcResourceShape(title = "VerificationCaseDefinition Resource Shape", describes = SysmlDomainConstants.VERIFICATIONCASEDEFINITION_TYPE)
public class VerificationCaseDefinition
    extends CaseDefinition
    implements IVerificationCaseDefinition
{
    ...
    public VerificationCaseDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.VERIFICATIONCASEDEFINITION_PATH,
        VerificationCaseDefinition.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local VerificationCaseDefinition Resource} - update VerificationCaseDefinition.toString() to present resource as desired.";
