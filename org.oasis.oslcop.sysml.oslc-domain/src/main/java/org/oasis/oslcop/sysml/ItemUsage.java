...
// End of user code
@OslcNamespace(SysmlDomainConstants.ITEMUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.ITEMUSAGE_LOCALNAME)
@OslcResourceShape(title = "ItemUsage Resource Shape", describes = SysmlDomainConstants.ITEMUSAGE_TYPE)
public class ItemUsage
    extends Usage
    implements IItemUsage
{
    ...
    public ItemUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ITEMUSAGE_PATH,
        ItemUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ItemUsage Resource} - update ItemUsage.toString() to present resource as desired.";
