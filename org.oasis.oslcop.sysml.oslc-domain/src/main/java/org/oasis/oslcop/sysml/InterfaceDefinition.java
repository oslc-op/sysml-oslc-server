...
// End of user code
@OslcNamespace(SysmlDomainConstants.INTERFACEDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.INTERFACEDEFINITION_LOCALNAME)
@OslcResourceShape(title = "InterfaceDefinition Resource Shape", describes = SysmlDomainConstants.INTERFACEDEFINITION_TYPE)
public class InterfaceDefinition
    extends ConnectionDefinition
    implements IInterfaceDefinition
{
    // Start of user code attributeAnnotation:interfaceEnd
    // End of user code
    private Set<Link> interfaceEnd = new HashSet<Link>();
    ...
    public InterfaceDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.INTERFACEDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local InterfaceDefinition Resource} - update InterfaceDefinition.toString() to present resource as desired.";
    ...
    public void addInterfaceEnd(final Link interfaceEnd)
    {
        this.interfaceEnd.add(interfaceEnd);
    }
    
    
    // Start of user code getterAnnotation:interfaceEnd
    // End of user code
    @OslcName("interfaceEnd")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "interfaceEnd")
    @OslcOccurs(Occurs.ZeroOrMany)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.PORTUSAGE_TYPE})
    @OslcReadOnly(false)
    public Set<Link> getInterfaceEnd()
    {
        // Start of user code getterInit:interfaceEnd
        // End of user code
        return interfaceEnd;
    }
    
    
    // Start of user code setterAnnotation:interfaceEnd
    // End of user code
    public void setInterfaceEnd(final Set<Link> interfaceEnd )
    {
        // Start of user code setterInit:interfaceEnd
        // End of user code
        this.interfaceEnd.clear();
        if (interfaceEnd != null)
        {
            this.interfaceEnd.addAll(interfaceEnd);
        }
    
        // Start of user code setterFinalize:interfaceEnd
        // End of user code
    }
