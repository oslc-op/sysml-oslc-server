...
// End of user code
@OslcNamespace(SysmlDomainConstants.RENDERINGDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.RENDERINGDEFINITION_LOCALNAME)
@OslcResourceShape(title = "RenderingDefinition Resource Shape", describes = SysmlDomainConstants.RENDERINGDEFINITION_TYPE)
public class RenderingDefinition
    extends PartDefinition
    implements IRenderingDefinition
{
    // Start of user code attributeAnnotation:rendering
    // End of user code
    private Set<Link> rendering = new HashSet<Link>();
    ...
    public RenderingDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.RENDERINGDEFINITION_PATH,
        RenderingDefinition.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local RenderingDefinition Resource} - update RenderingDefinition.toString() to present resource as desired.";
    ...
    public void addRendering(final Link rendering)
    {
    ...
    // End of user code
    public void setRendering(final Set<Link> rendering )
    {
        ...
        if (rendering != null)
        {
            this.rendering.addAll(rendering);
        }
