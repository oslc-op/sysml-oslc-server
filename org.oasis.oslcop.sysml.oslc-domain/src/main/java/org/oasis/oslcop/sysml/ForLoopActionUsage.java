...
// End of user code
@OslcNamespace(SysmlDomainConstants.FORLOOPACTIONUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.FORLOOPACTIONUSAGE_LOCALNAME)
@OslcResourceShape(title = "ForLoopActionUsage Shape", describes = SysmlDomainConstants.FORLOOPACTIONUSAGE_TYPE)
public class ForLoopActionUsage
    extends LoopActionUsage
    implements IForLoopActionUsage
{
    // Start of user code attributeAnnotation:seqArgument
    // End of user code
    private Link seqArgument;
    // Start of user code attributeAnnotation:loopVariable
    // End of user code
    private Link loopVariable;
    ...
    public ForLoopActionUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.FORLOOPACTIONUSAGE_PATH,
        ForLoopActionUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ForLoopActionUsage Resource} - update ForLoopActionUsage.toString() to present resource as desired.";
 ...
 result = getShortTitle();
    ...
    // Start of user code getterAnnotation:seqArgument
    // End of user code
    @OslcName("seqArgument")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "seqArgument")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.EXPRESSION_TYPE})
    @OslcReadOnly(false)
    public Link getSeqArgument()
    {
        // Start of user code getterInit:seqArgument
        // End of user code
        return seqArgument;
    }
    
    // Start of user code getterAnnotation:loopVariable
    // End of user code
    @OslcName("loopVariable")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "loopVariable")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.REFERENCEUSAGE_TYPE})
    @OslcReadOnly(false)
    public Link getLoopVariable()
    {
        // Start of user code getterInit:loopVariable
        // End of user code
        return loopVariable;
    }
    
    
    // Start of user code setterAnnotation:seqArgument
    // End of user code
    public void setSeqArgument(final Link seqArgument )
    {
        // Start of user code setterInit:seqArgument
        // End of user code
        this.seqArgument = seqArgument;
    
        // Start of user code setterFinalize:seqArgument
        // End of user code
    }
    
    // Start of user code setterAnnotation:loopVariable
    // End of user code
    public void setLoopVariable(final Link loopVariable )
    {
        // Start of user code setterInit:loopVariable
        // End of user code
        this.loopVariable = loopVariable;
    
        // Start of user code setterFinalize:loopVariable
        // End of user code
    }
