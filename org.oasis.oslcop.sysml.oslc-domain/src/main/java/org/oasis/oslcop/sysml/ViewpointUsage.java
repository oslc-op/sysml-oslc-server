    ...
    implements IViewpointUsage
{
    ...
    public ViewpointUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.VIEWPOINTUSAGE_PATH,
        ViewpointUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ViewpointUsage Resource} - update ViewpointUsage.toString() to present resource as desired.";
    ...
    // Start of user code getterAnnotation:viewpointDefinition
    // End of user code
    @OslcName("viewpointDefinition")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "viewpointDefinition")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.VIEWPOINTDEFINITION_TYPE})
    @OslcReadOnly(false)
    public Link getViewpointDefinition()
    {
        // Start of user code getterInit:viewpointDefinition
        // End of user code
    ...
    // End of user code
    public void setViewpointDefinition(final Link viewpointDefinition )
    {
        // Start of user code setterInit:viewpointDefinition
        // End of user code
