    ...
    implements IInvariant
{
    ...
    public Invariant(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.INVARIANT_PATH,
        Invariant.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Invariant Resource} - update Invariant.toString() to present resource as desired.";
