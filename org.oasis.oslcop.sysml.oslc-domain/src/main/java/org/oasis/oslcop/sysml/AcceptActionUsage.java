    ...
    implements IAcceptActionUsage
{
    ...
    public AcceptActionUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ACCEPTACTIONUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local AcceptActionUsage Resource} - update AcceptActionUsage.toString() to present resource as desired.";
