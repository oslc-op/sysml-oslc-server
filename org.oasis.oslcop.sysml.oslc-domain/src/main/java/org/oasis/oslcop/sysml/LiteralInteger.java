...
// End of user code
@OslcNamespace(SysmlDomainConstants.LITERALINTEGER_NAMESPACE)
@OslcName(SysmlDomainConstants.LITERALINTEGER_LOCALNAME)
@OslcResourceShape(title = "LiteralInteger Resource Shape", describes = SysmlDomainConstants.LITERALINTEGER_TYPE)
public class LiteralInteger
    extends LiteralExpression
    implements ILiteralInteger
{
    ...
    public LiteralInteger(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.LITERALINTEGER_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local LiteralInteger Resource} - update LiteralInteger.toString() to present resource as desired.";
