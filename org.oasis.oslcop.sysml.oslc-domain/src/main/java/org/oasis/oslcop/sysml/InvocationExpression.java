...
// End of user code
@OslcNamespace(SysmlDomainConstants.INVOCATIONEXPRESSION_NAMESPACE)
@OslcName(SysmlDomainConstants.INVOCATIONEXPRESSION_LOCALNAME)
@OslcResourceShape(title = "InvocationExpression Resource Shape", describes = SysmlDomainConstants.INVOCATIONEXPRESSION_TYPE)
    ...
    implements IInvocationExpression
{
    ...
    public InvocationExpression(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.INVOCATIONEXPRESSION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local InvocationExpression Resource} - update InvocationExpression.toString() to present resource as desired.";
    ...
    // End of user code
    @OslcName("argument")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "argument")
