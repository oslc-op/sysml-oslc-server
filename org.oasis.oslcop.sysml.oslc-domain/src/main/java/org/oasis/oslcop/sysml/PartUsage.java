...
// End of user code
@OslcNamespace(SysmlDomainConstants.PARTUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.PARTUSAGE_LOCALNAME)
@OslcResourceShape(title = "PartUsage Resource Shape", describes = SysmlDomainConstants.PARTUSAGE_TYPE)
public class PartUsage
    extends ItemUsage
    implements IPartUsage
{
    ...
    public PartUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.PARTUSAGE_PATH,
        PartUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local PartUsage Resource} - update PartUsage.toString() to present resource as desired.";
