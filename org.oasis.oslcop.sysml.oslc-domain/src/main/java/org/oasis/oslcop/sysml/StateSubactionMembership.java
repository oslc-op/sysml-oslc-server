    ...
    implements IStateSubactionMembership
{
    ...
    public StateSubactionMembership(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.STATESUBACTIONMEMBERSHIP_PATH,
        StateSubactionMembership.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local StateSubactionMembership Resource} - update StateSubactionMembership.toString() to present resource as desired.";
