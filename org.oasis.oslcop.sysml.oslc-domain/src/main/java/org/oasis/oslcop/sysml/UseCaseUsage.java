...
// End of user code
@OslcNamespace(SysmlDomainConstants.USECASEUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.USECASEUSAGE_LOCALNAME)
@OslcResourceShape(title = "UseCaseUsage Shape", describes = SysmlDomainConstants.USECASEUSAGE_TYPE)
public class UseCaseUsage
    extends CaseUsage
    implements IUseCaseUsage
{
    // Start of user code attributeAnnotation:useCaseDefinition
    // End of user code
    private Link useCaseDefinition;
    // Start of user code attributeAnnotation:includedUseCase
    // End of user code
    private Set<Link> includedUseCase = new HashSet<Link>();
    ...
    public UseCaseUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.USECASEUSAGE_PATH,
        UseCaseUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local UseCaseUsage Resource} - update UseCaseUsage.toString() to present resource as desired.";
 ...
 result = getShortTitle();
    ...
    public void addIncludedUseCase(final Link includedUseCase)
    {
        this.includedUseCase.add(includedUseCase);
    }
    
    
    // Start of user code getterAnnotation:useCaseDefinition
    // End of user code
    @OslcName("useCaseDefinition")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "useCaseDefinition")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.USECASEDEFINITION_TYPE})
    @OslcReadOnly(false)
    public Link getUseCaseDefinition()
    {
        // Start of user code getterInit:useCaseDefinition
        // End of user code
        return useCaseDefinition;
    }
    
    // Start of user code getterAnnotation:includedUseCase
    // End of user code
    @OslcName("includedUseCase")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "includedUseCase")
    @OslcOccurs(Occurs.ZeroOrMany)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.USECASEUSAGE_TYPE})
    @OslcReadOnly(false)
    public Set<Link> getIncludedUseCase()
    {
        // Start of user code getterInit:includedUseCase
        // End of user code
        return includedUseCase;
    }
    
    
    // Start of user code setterAnnotation:useCaseDefinition
    // End of user code
    public void setUseCaseDefinition(final Link useCaseDefinition )
    {
        // Start of user code setterInit:useCaseDefinition
        // End of user code
        this.useCaseDefinition = useCaseDefinition;
    
        // Start of user code setterFinalize:useCaseDefinition
        // End of user code
    }
    
    // Start of user code setterAnnotation:includedUseCase
    // End of user code
    public void setIncludedUseCase(final Set<Link> includedUseCase )
    {
        // Start of user code setterInit:includedUseCase
        // End of user code
        this.includedUseCase.clear();
        if (includedUseCase != null)
        {
            this.includedUseCase.addAll(includedUseCase);
        }
    
        // Start of user code setterFinalize:includedUseCase
        // End of user code
    }
