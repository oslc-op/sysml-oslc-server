...
// End of user code
@OslcNamespace(SysmlDomainConstants.CONNECTORASUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.CONNECTORASUSAGE_LOCALNAME)
@OslcResourceShape(title = "ConnectorAsUsage Shape", describes = SysmlDomainConstants.CONNECTORASUSAGE_TYPE)
public class ConnectorAsUsage
    extends Usage
    implements IConnectorAsUsage, IConnector, IRelationship
{
    ...
    public ConnectorAsUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.CONNECTORASUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ConnectorAsUsage Resource} - update ConnectorAsUsage.toString() to present resource as desired.";
