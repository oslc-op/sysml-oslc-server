...
// End of user code
@OslcNamespace(SysmlDomainConstants.LITERALRATIONAL_NAMESPACE)
@OslcName(SysmlDomainConstants.LITERALRATIONAL_LOCALNAME)
@OslcResourceShape(title = "LiteralRational Shape", describes = SysmlDomainConstants.LITERALRATIONAL_TYPE)
public class LiteralRational
    extends LiteralExpression
    implements ILiteralRational
{
    ...
    public LiteralRational(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.LITERALRATIONAL_PATH,
        LiteralRational.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local LiteralRational Resource} - update LiteralRational.toString() to present resource as desired.";
