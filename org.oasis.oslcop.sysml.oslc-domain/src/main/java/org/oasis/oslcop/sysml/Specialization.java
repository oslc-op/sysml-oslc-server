...
// End of user code
@OslcNamespace(SysmlDomainConstants.SPECIALIZATION_NAMESPACE)
@OslcName(SysmlDomainConstants.SPECIALIZATION_LOCALNAME)
@OslcResourceShape(title = "Specialization Shape", describes = SysmlDomainConstants.SPECIALIZATION_TYPE)
    ...
    implements ISpecialization
{
    ...
    public Specialization(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.SPECIALIZATION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Specialization Resource} - update Specialization.toString() to present resource as desired.";
