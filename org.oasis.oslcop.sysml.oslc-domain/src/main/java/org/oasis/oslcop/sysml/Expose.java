    ...
    implements IExpose
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.EXPOSE_PATH,
        Expose.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Expose Resource} - update Expose.toString() to present resource as desired.";
