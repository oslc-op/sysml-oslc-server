...
import org.oasis.oslcop.sysml.ConcernDefinition;
...
// End of user code
@OslcNamespace(SysmlDomainConstants.CONCERNUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.CONCERNUSAGE_LOCALNAME)
@OslcResourceShape(title = "ConcernUsage Shape", describes = SysmlDomainConstants.CONCERNUSAGE_TYPE)
public class ConcernUsage
    extends RequirementUsage
    implements IConcernUsage
{
    // Start of user code attributeAnnotation:concernDefinition
    // End of user code
    private Link concernDefinition;
    ...
    public ConcernUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.CONCERNUSAGE_PATH,
        ConcernUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ConcernUsage Resource} - update ConcernUsage.toString() to present resource as desired.";
 ...
 result = getShortTitle();
    ...
    // Start of user code getterAnnotation:concernDefinition
    // End of user code
    @OslcName("concernDefinition")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "concernDefinition")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.CONCERNDEFINITION_TYPE})
    @OslcReadOnly(false)
    public Link getConcernDefinition()
    {
        // Start of user code getterInit:concernDefinition
        // End of user code
        return concernDefinition;
    }
    
    
    // Start of user code setterAnnotation:concernDefinition
    // End of user code
    public void setConcernDefinition(final Link concernDefinition )
    {
        // Start of user code setterInit:concernDefinition
        // End of user code
        this.concernDefinition = concernDefinition;
    
        // Start of user code setterFinalize:concernDefinition
        // End of user code
    }
