    ...
    implements IExhibitStateUsage, IEventOccurrenceUsage, IPerformActionUsage, IStep
{
    ...
    public ExhibitStateUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.EXHIBITSTATEUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ExhibitStateUsage Resource} - update ExhibitStateUsage.toString() to present resource as desired.";
 ...
 result = getShortTitle();
    ...
    // Start of user code getterAnnotation:exhibitedState
    // End of user code
    ...
    {
        // Start of user code getterInit:exhibitedState
        // End of user code
    ...
    {
        // Start of user code setterInit:exhibitedState
        // End of user code
