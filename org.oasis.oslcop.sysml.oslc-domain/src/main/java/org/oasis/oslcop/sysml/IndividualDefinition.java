...
// End of user code
@OslcNamespace(SysmlDomainConstants.INDIVIDUALDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.INDIVIDUALDEFINITION_LOCALNAME)
@OslcResourceShape(title = "IndividualDefinition Resource Shape", describes = SysmlDomainConstants.INDIVIDUALDEFINITION_TYPE)
public class IndividualDefinition
    extends ItemDefinition
    implements IIndividualDefinition
{
    ...
    public IndividualDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.INDIVIDUALDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local IndividualDefinition Resource} - update IndividualDefinition.toString() to present resource as desired.";
