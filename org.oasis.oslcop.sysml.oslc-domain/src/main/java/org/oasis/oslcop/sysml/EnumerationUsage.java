...
public class EnumerationUsage
    ...
    implements IEnumerationUsage
{
    // Start of user code attributeAnnotation:enumerationDefinition
    // End of user code
    private Link enumerationDefinition;
    ...
    public EnumerationUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ENUMERATIONUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local EnumerationUsage Resource} - update EnumerationUsage.toString() to present resource as desired.";
    ...
    // Start of user code getterAnnotation:enumerationDefinition
    // End of user code
    @OslcName("enumerationDefinition")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "enumerationDefinition")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.ENUMERATIONDEFINITION_TYPE})
    @OslcReadOnly(false)
    public Link getEnumerationDefinition()
    {
        // Start of user code getterInit:enumerationDefinition
        // End of user code
        return enumerationDefinition;
    }
    
    
    // Start of user code setterAnnotation:enumerationDefinition
    // End of user code
    public void setEnumerationDefinition(final Link enumerationDefinition )
    {
        // Start of user code setterInit:enumerationDefinition
        // End of user code
        this.enumerationDefinition = enumerationDefinition;
    
        // Start of user code setterFinalize:enumerationDefinition
        // End of user code
    }
