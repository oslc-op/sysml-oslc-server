...
// End of user code
@OslcNamespace(SysmlDomainConstants.EVENTOCCURRENCEUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.EVENTOCCURRENCEUSAGE_LOCALNAME)
@OslcResourceShape(title = "EventOccurrenceUsage Shape", describes = SysmlDomainConstants.EVENTOCCURRENCEUSAGE_TYPE)
public class EventOccurrenceUsage
    extends OccurrenceUsage
    implements IEventOccurrenceUsage
{
    ...
    public EventOccurrenceUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.EVENTOCCURRENCEUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local EventOccurrenceUsage Resource} - update EventOccurrenceUsage.toString() to present resource as desired.";
