...
// End of user code
@OslcNamespace(SysmlDomainConstants.BINDINGCONNECTORASUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.BINDINGCONNECTORASUSAGE_LOCALNAME)
@OslcResourceShape(title = "BindingConnectorAsUsage Shape", describes = SysmlDomainConstants.BINDINGCONNECTORASUSAGE_TYPE)
public class BindingConnectorAsUsage
    extends ConnectorAsUsage
    implements IBindingConnectorAsUsage, IBindingConnector, IConnector, IRelationship
{
    ...
    public BindingConnectorAsUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.BINDINGCONNECTORASUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local BindingConnectorAsUsage Resource} - update BindingConnectorAsUsage.toString() to present resource as desired.";
