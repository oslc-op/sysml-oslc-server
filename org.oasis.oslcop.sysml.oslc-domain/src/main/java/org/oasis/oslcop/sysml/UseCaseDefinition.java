...
// End of user code
@OslcNamespace(SysmlDomainConstants.USECASEDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.USECASEDEFINITION_LOCALNAME)
@OslcResourceShape(title = "UseCaseDefinition Shape", describes = SysmlDomainConstants.USECASEDEFINITION_TYPE)
public class UseCaseDefinition
    extends CaseDefinition
    implements IUseCaseDefinition
{
    ...
    public UseCaseDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.USECASEDEFINITION_PATH,
        UseCaseDefinition.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local UseCaseDefinition Resource} - update UseCaseDefinition.toString() to present resource as desired.";
