...
// End of user code
@OslcNamespace(SysmlDomainConstants.OCCURRENCEDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.OCCURRENCEDEFINITION_LOCALNAME)
@OslcResourceShape(title = "OccurrenceDefinition Shape", describes = SysmlDomainConstants.OCCURRENCEDEFINITION_TYPE)
public class OccurrenceDefinition
    extends Definition
    implements IOccurrenceDefinition, ISysmlClass
{
    // Start of user code attributeAnnotation:isIndividual
    // End of user code
    private Boolean isIndividual;
    // Start of user code attributeAnnotation:lifeClass
    // End of user code
    private Link lifeClass;
    ...
    public OccurrenceDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.OCCURRENCEDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local OccurrenceDefinition Resource} - update OccurrenceDefinition.toString() to present resource as desired.";
 ...
 result = getShortTitle();
    ...
    // Start of user code getterAnnotation:lifeClass
    // End of user code
    @OslcName("lifeClass")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "lifeClass")
    @OslcOccurs(Occurs.ZeroOrOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.LIFECLASS_TYPE})
    @OslcReadOnly(false)
    public Link getLifeClass()
    {
        // Start of user code getterInit:lifeClass
        // End of user code
        return lifeClass;
    }
    ...
    // Start of user code setterAnnotation:lifeClass
    // End of user code
    public void setLifeClass(final Link lifeClass )
    {
        // Start of user code setterInit:lifeClass
        // End of user code
        this.lifeClass = lifeClass;
    
        // Start of user code setterFinalize:lifeClass
        // End of user code
    }
