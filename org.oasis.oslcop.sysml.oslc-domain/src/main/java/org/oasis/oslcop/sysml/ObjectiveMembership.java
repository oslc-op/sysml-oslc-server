    ...
    implements IObjectiveMembership
{
    ...
    public ObjectiveMembership(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.OBJECTIVEMEMBERSHIP_PATH,
        ObjectiveMembership.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ObjectiveMembership Resource} - update ObjectiveMembership.toString() to present resource as desired.";
    ...
    {
        // Start of user code getterInit:ownedObjectiveRequirement
        // End of user code
    ...
    {
        // Start of user code setterInit:ownedObjectiveRequirement
        // End of user code
        this.ownedObjectiveRequirement = ownedObjectiveRequirement;
    
        // Start of user code setterFinalize:ownedObjectiveRequirement
        // End of user code
    }
