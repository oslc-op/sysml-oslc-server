    ...
    implements IMetadataFeature
{
    ...
    public MetadataFeature(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.METADATAFEATURE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local MetadataFeature Resource} - update MetadataFeature.toString() to present resource as desired.";
    ...
    {
        // Start of user code getterInit:metadataFeatureValue
        // End of user code
    ...
    {
        // Start of user code setterInit:metadataFeatureValue
        // End of user code
        this.metadataFeatureValue = metadataFeatureValue;
    
        // Start of user code setterFinalize:metadataFeatureValue
        // End of user code
    }
