    ...
    implements IReferenceUsage
{
    ...
    public ReferenceUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.REFERENCEUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ReferenceUsage Resource} - update ReferenceUsage.toString() to present resource as desired.";
