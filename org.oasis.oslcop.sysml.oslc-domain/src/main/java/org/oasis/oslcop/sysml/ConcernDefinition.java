...
// End of user code
@OslcNamespace(SysmlDomainConstants.CONCERNDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.CONCERNDEFINITION_LOCALNAME)
@OslcResourceShape(title = "ConcernDefinition Shape", describes = SysmlDomainConstants.CONCERNDEFINITION_TYPE)
public class ConcernDefinition
    extends RequirementDefinition
    implements IConcernDefinition
{
    ...
    public ConcernDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.CONCERNDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ConcernDefinition Resource} - update ConcernDefinition.toString() to present resource as desired.";
