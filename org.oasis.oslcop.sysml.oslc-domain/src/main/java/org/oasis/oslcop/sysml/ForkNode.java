...
// End of user code
@OslcNamespace(SysmlDomainConstants.FORKNODE_NAMESPACE)
@OslcName(SysmlDomainConstants.FORKNODE_LOCALNAME)
@OslcResourceShape(title = "ForkNode Resource Shape", describes = SysmlDomainConstants.FORKNODE_TYPE)
    ...
    implements IForkNode
{
    ...
    public ForkNode(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.FORKNODE_PATH,
        ForkNode.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ForkNode Resource} - update ForkNode.toString() to present resource as desired.";
