    ...
    implements ICaseUsage
{
    ...
    public CaseUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.CASEUSAGE_PATH,
        CaseUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local CaseUsage Resource} - update CaseUsage.toString() to present resource as desired.";
    ...
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "caseDefinition")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.CASEDEFINITION_TYPE})
    @OslcReadOnly(false)
    public Link getCaseDefinition()
    {
        // Start of user code getterInit:caseDefinition
        // End of user code
    ...
    {
        // Start of user code setterInit:caseDefinition
        // End of user code
