...
// End of user code
@OslcNamespace(SysmlDomainConstants.PARTDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.PARTDEFINITION_LOCALNAME)
@OslcResourceShape(title = "PartDefinition Resource Shape", describes = SysmlDomainConstants.PARTDEFINITION_TYPE)
    ...
    implements IPartDefinition
{
    ...
    public PartDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.PARTDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local PartDefinition Resource} - update PartDefinition.toString() to present resource as desired.";
