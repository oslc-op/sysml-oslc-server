...
// End of user code
@OslcNamespace(SysmlDomainConstants.FLOWCONNECTIONUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.FLOWCONNECTIONUSAGE_LOCALNAME)
@OslcResourceShape(title = "FlowConnectionUsage Shape", describes = SysmlDomainConstants.FLOWCONNECTIONUSAGE_TYPE)
public class FlowConnectionUsage
    extends ConnectionUsage
    implements IFlowConnectionUsage, IConnector, IItemFlow, IRelationship, IStep
{
    ...
    public FlowConnectionUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.FLOWCONNECTIONUSAGE_PATH,
        FlowConnectionUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local FlowConnectionUsage Resource} - update FlowConnectionUsage.toString() to present resource as desired.";
