...
import org.oasis.oslcop.sysml.IAcceptActionUsage;
...
@OslcResourceShape(title = "TransitionUsage Shape", describes = SysmlDomainConstants.TRANSITIONUSAGE_TYPE)
public interface ITransitionUsage
{
