...
// End of user code
@OslcNamespace(SysmlDomainConstants.LOOPACTIONUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.LOOPACTIONUSAGE_LOCALNAME)
@OslcResourceShape(title = "LoopActionUsage Shape", describes = SysmlDomainConstants.LOOPACTIONUSAGE_TYPE)
public class LoopActionUsage
    extends ActionUsage
    implements ILoopActionUsage
{
    // Start of user code attributeAnnotation:bodyAction
    // End of user code
    private Link bodyAction;
    ...
    public LoopActionUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.LOOPACTIONUSAGE_PATH,
        LoopActionUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local LoopActionUsage Resource} - update LoopActionUsage.toString() to present resource as desired.";
 ...
 result = getShortTitle();
    ...
    // Start of user code getterAnnotation:bodyAction
    // End of user code
    @OslcName("bodyAction")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "bodyAction")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.ACTIONUSAGE_TYPE})
    @OslcReadOnly(false)
    public Link getBodyAction()
    {
        // Start of user code getterInit:bodyAction
        // End of user code
        return bodyAction;
    }
    
    
    // Start of user code setterAnnotation:bodyAction
    // End of user code
    public void setBodyAction(final Link bodyAction )
    {
        // Start of user code setterInit:bodyAction
        // End of user code
        this.bodyAction = bodyAction;
    
        // Start of user code setterFinalize:bodyAction
        // End of user code
    }
