...
// End of user code
@OslcNamespace(SysmlDomainConstants.PORTIONINGFEATURE_NAMESPACE)
@OslcName(SysmlDomainConstants.PORTIONINGFEATURE_LOCALNAME)
@OslcResourceShape(title = "PortioningFeature Shape", describes = SysmlDomainConstants.PORTIONINGFEATURE_TYPE)
public class PortioningFeature
    extends Feature
    implements IPortioningFeature
{
    ...
    public PortioningFeature(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.PORTIONINGFEATURE_PATH,
        PortioningFeature.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local PortioningFeature Resource} - update PortioningFeature.toString() to present resource as desired.";
