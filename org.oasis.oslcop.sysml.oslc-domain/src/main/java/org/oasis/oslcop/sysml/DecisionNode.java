...
import org.oasis.oslcop.sysml.ControlNode;
    ...
    implements IDecisionNode
{
    ...
    public DecisionNode(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.DECISIONNODE_PATH,
        DecisionNode.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local DecisionNode Resource} - update DecisionNode.toString() to present resource as desired.";
