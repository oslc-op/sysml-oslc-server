...
// End of user code
@OslcNamespace(SysmlDomainConstants.SUCCESSIONASUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.SUCCESSIONASUSAGE_LOCALNAME)
@OslcResourceShape(title = "SuccessionAsUsage Shape", describes = SysmlDomainConstants.SUCCESSIONASUSAGE_TYPE)
public class SuccessionAsUsage
    extends ConnectorAsUsage
    implements ISuccessionAsUsage, IConnector, IRelationship, ISuccession
{
    ...
    public SuccessionAsUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.SUCCESSIONASUSAGE_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local SuccessionAsUsage Resource} - update SuccessionAsUsage.toString() to present resource as desired.";
