...
// End of user code
@OslcNamespace(SysmlDomainConstants.OCCURRENCEUSAGE_NAMESPACE)
@OslcName(SysmlDomainConstants.OCCURRENCEUSAGE_LOCALNAME)
@OslcResourceShape(title = "OccurrenceUsage Shape", describes = SysmlDomainConstants.OCCURRENCEUSAGE_TYPE)
public class OccurrenceUsage
    extends Usage
    implements IOccurrenceUsage
{
    ...
    public OccurrenceUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.OCCURRENCEUSAGE_PATH,
        OccurrenceUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local OccurrenceUsage Resource} - update OccurrenceUsage.toString() to present resource as desired.";
