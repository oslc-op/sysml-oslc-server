...
// End of user code
@OslcNamespace(SysmlDomainConstants.BEHAVIOR_NAMESPACE)
@OslcName(SysmlDomainConstants.BEHAVIOR_LOCALNAME)
@OslcResourceShape(title = "Behavior Shape", describes = SysmlDomainConstants.BEHAVIOR_TYPE)
    ...
    implements IBehavior
{
    ...
    public Behavior(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.BEHAVIOR_PATH,
        Behavior.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Behavior Resource} - update Behavior.toString() to present resource as desired.";
