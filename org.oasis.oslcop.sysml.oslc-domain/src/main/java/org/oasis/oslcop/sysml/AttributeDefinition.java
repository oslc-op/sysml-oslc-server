...
// End of user code
@OslcNamespace(SysmlDomainConstants.ATTRIBUTEDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.ATTRIBUTEDEFINITION_LOCALNAME)
@OslcResourceShape(title = "AttributeDefinition Resource Shape", describes = SysmlDomainConstants.ATTRIBUTEDEFINITION_TYPE)
public class AttributeDefinition
    extends Definition
    implements IAttributeDefinition, IDataType
{
    ...
    public AttributeDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ATTRIBUTEDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local AttributeDefinition Resource} - update AttributeDefinition.toString() to present resource as desired.";
