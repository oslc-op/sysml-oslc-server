    ...
    implements IEndFeatureMembership
{
    ...
    public EndFeatureMembership(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ENDFEATUREMEMBERSHIP_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local EndFeatureMembership Resource} - update EndFeatureMembership.toString() to present resource as desired.";
