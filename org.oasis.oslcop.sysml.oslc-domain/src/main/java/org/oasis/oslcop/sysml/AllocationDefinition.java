...
// End of user code
@OslcNamespace(SysmlDomainConstants.ALLOCATIONDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.ALLOCATIONDEFINITION_LOCALNAME)
@OslcResourceShape(title = "AllocationDefinition Resource Shape", describes = SysmlDomainConstants.ALLOCATIONDEFINITION_TYPE)
public class AllocationDefinition
    extends ConnectionDefinition
    implements IAllocationDefinition
{
    // Start of user code attributeAnnotation:allocation
    // End of user code
    private Set<Link> allocation = new HashSet<Link>();
    ...
    public AllocationDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ALLOCATIONDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local AllocationDefinition Resource} - update AllocationDefinition.toString() to present resource as desired.";
    ...
    public void addAllocation(final Link allocation)
    {
        this.allocation.add(allocation);
    }
    
    
    // Start of user code getterAnnotation:allocation
    // End of user code
    @OslcName("allocation")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "allocation")
    @OslcOccurs(Occurs.ZeroOrMany)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.ALLOCATIONUSAGE_TYPE})
    @OslcReadOnly(false)
    public Set<Link> getAllocation()
    {
        // Start of user code getterInit:allocation
        // End of user code
        return allocation;
    }
    
    
    // Start of user code setterAnnotation:allocation
    // End of user code
    public void setAllocation(final Set<Link> allocation )
    {
        // Start of user code setterInit:allocation
        // End of user code
        this.allocation.clear();
        if (allocation != null)
        {
            this.allocation.addAll(allocation);
        }
    
        // Start of user code setterFinalize:allocation
        // End of user code
    }
