    ...
    implements IAnnotatingElement
{
    ...
    public AnnotatingElement(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ANNOTATINGELEMENT_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local AnnotatingElement Resource} - update AnnotatingElement.toString() to present resource as desired.";
