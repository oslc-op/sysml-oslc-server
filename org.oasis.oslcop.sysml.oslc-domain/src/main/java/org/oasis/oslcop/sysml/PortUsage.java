    ...
    implements IPortUsage
{
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.PORTUSAGE_PATH,
        PortUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local PortUsage Resource} - update PortUsage.toString() to present resource as desired.";
    ...
    // Start of user code getterAnnotation:portOwningUsage
    // End of user code
    @OslcName("portOwningUsage")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "portOwningUsage")
    ...
    {
        // Start of user code getterInit:portOwningUsage
        // End of user code
    ...
    // Start of user code setterAnnotation:portOwningUsage
    // End of user code
    public void setPortOwningUsage(final Link portOwningUsage )
    {
        // Start of user code setterInit:portOwningUsage
        // End of user code
        this.portOwningUsage = portOwningUsage;
    
        // Start of user code setterFinalize:portOwningUsage
        // End of user code
    }
