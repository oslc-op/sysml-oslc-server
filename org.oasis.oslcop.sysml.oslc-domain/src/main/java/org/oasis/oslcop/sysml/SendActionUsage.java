    ...
    implements ISendActionUsage
{
    ...
    public SendActionUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.SENDACTIONUSAGE_PATH,
        SendActionUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local SendActionUsage Resource} - update SendActionUsage.toString() to present resource as desired.";
