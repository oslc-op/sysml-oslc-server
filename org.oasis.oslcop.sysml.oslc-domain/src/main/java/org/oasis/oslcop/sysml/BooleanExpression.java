    ...
    implements IBooleanExpression
{
    ...
    public BooleanExpression(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.BOOLEANEXPRESSION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local BooleanExpression Resource} - update BooleanExpression.toString() to present resource as desired.";
