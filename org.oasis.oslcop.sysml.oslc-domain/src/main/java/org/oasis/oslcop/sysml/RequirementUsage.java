...
public class RequirementUsage
    extends ConstraintUsage
    implements IRequirementUsage
{
    ...
    public RequirementUsage(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.REQUIREMENTUSAGE_PATH,
        RequirementUsage.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local RequirementUsage Resource} - update RequirementUsage.toString() to present resource as desired.";
    ...
    // Start of user code getterAnnotation:requirementDefinition
    // End of user code
    ...
    // Start of user code setterAnnotation:requirementDefinition
    // End of user code
    public void setRequirementDefinition(final Link requirementDefinition )
    {
        // Start of user code setterInit:requirementDefinition
        // End of user code
