    ...
    implements IElementFilterMembership
{
    ...
    public ElementFilterMembership(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ELEMENTFILTERMEMBERSHIP_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ElementFilterMembership Resource} - update ElementFilterMembership.toString() to present resource as desired.";
