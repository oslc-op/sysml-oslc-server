...
// End of user code
@OslcNamespace(SysmlDomainConstants.CONJUGATEDPORTDEFINITION_NAMESPACE)
@OslcName(SysmlDomainConstants.CONJUGATEDPORTDEFINITION_LOCALNAME)
@OslcResourceShape(title = "ConjugatedPortDefinition Resource Shape", describes = SysmlDomainConstants.CONJUGATEDPORTDEFINITION_TYPE)
public class ConjugatedPortDefinition
    extends PortDefinition
    implements IConjugatedPortDefinition
{
    // Start of user code attributeAnnotation:ownedPortConjugator
    // End of user code
    private Link ownedPortConjugator;
    ...
    public ConjugatedPortDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.CONJUGATEDPORTDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ConjugatedPortDefinition Resource} - update ConjugatedPortDefinition.toString() to present resource as desired.";
    ...
    // Start of user code getterAnnotation:ownedPortConjugator
    // End of user code
    @OslcName("ownedPortConjugator")
    @OslcPropertyDefinition(SysmlDomainConstants.SYSML_NAMSPACE + "ownedPortConjugator")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.Resource)
    @OslcRange({SysmlDomainConstants.PORTCONJUGATION_TYPE})
    @OslcReadOnly(false)
    public Link getOwnedPortConjugator()
    {
        // Start of user code getterInit:ownedPortConjugator
        // End of user code
    ...
    // Start of user code setterAnnotation:ownedPortConjugator
    // End of user code
    public void setOwnedPortConjugator(final Link ownedPortConjugator )
    {
        // Start of user code setterInit:ownedPortConjugator
        // End of user code
        this.ownedPortConjugator = ownedPortConjugator;
    
        // Start of user code setterFinalize:ownedPortConjugator
        // End of user code
    }
