...
if (request.getParameter("resourceUri") != null) {
    aResource = new Relationship (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aRelationship") != null) {
        aResource = (Relationship) request.getAttribute("aRelationship");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local Relationship Resource} - update Relationship.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
