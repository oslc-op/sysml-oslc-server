...
public class AuthenticationApplication implements Application {
    ...
    public final static String APPLICATION_NAME = "SysmlServer";
    public final static String OAUTH_REALM = "SysmlServer";
    ...
    public void login(HttpServletRequest request, String username, String password) throws AuthenticationException {
        ...
        SysMLClient apiClient = new SysMLClient(username, password);
    	request.getSession().setAttribute(SysMLClient.APICLIENT_ATTRIBUTE, apiClient);
