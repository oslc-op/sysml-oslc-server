...
// End of user code
@Path("projects/{projectId}/commits/{commitId}/subsettings")
@Api(value = "Web Service for {" + SysmlDomainConstants.SUBSETTING_LOCALNAME + "}")
public class SubsettingService
{
    ...
    @ApiOperation(
        value = "GET for resources of type {'" + SysmlDomainConstants.SUBSETTING_LOCALNAME + "'}",
        notes = "GET for resources of type {'" + "<a href=\"" + SysmlDomainConstants.SUBSETTING_TYPE + "\">" + SysmlDomainConstants.SUBSETTING_LOCALNAME + "</a>" + "'}" +
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final Subsetting aSubsetting = SysmlServerManager.getSubsetting(httpServletRequest, projectId, commitId, id);
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/subsetting.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/subsettingsmallpreview.jsp");
            httpServletResponse.addHeader(SysmlServerConstants.HDR_OSLC_VERSION, SysmlServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSubsetting != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/oasis/oslcop/sysml/subsettinglargepreview.jsp");
            httpServletResponse.addHeader(SysmlServerConstants.HDR_OSLC_VERSION, SysmlServerConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
