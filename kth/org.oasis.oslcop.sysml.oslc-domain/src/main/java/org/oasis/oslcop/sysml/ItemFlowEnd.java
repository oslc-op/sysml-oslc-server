    ...
    implements IItemFlowEnd
{
    ...
    public ItemFlowEnd(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.ITEMFLOWEND_PATH,
        ItemFlowEnd.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ItemFlowEnd Resource} - update ItemFlowEnd.toString() to present resource as desired.";
