    ...
    implements IStateDefinition
{
    ...
    public StateDefinition(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.STATEDEFINITION_PATH,
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local StateDefinition Resource} - update StateDefinition.toString() to present resource as desired.";
