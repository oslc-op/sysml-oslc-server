...
// End of user code
@OslcNamespace(SysmlDomainConstants.MERGENODE_NAMESPACE)
@OslcName(SysmlDomainConstants.MERGENODE_LOCALNAME)
@OslcResourceShape(title = "MergeNode Resource Shape", describes = SysmlDomainConstants.MERGENODE_TYPE)
    ...
    implements IMergeNode
{
    ...
    public MergeNode(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.MERGENODE_PATH,
        MergeNode.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local MergeNode Resource} - update MergeNode.toString() to present resource as desired.";
