    ...
    implements IReturnParameterMembership
{
    ...
    public ReturnParameterMembership(final URI about)
    {
        super(about);
    ...
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        ...
        SysmlDomainConstants.RETURNPARAMETERMEMBERSHIP_PATH,
        ReturnParameterMembership.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local ReturnParameterMembership Resource} - update ReturnParameterMembership.toString() to present resource as desired.";
